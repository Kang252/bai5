      ...
      <View style={styles.leftContainer}>
        ...
        <View>
          ...
          <Text style={styles.streakText}>
            🔥 Chuỗi: <Text style={{fontWeight:'bold'}}>{habit.currentStreak}</Text> ngày 
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
    card: {
        ...
        padding: 15, marginHorizontal: 15, marginVertical: 8, borderRadius: 12,
        borderLeftWidth: 5, elevation: 1, shadowColor: '#000',
    ...
    streakText: { fontSize: 14, color: '#666', marginTop: 4 },
    statusCircle: {
